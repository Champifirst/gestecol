...
<body class="nav-md">
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Enregistrer les cycles d'une école</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="" id="from_cycle" method="post" enctype="multipart/form-data" novalidate>
                                        
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Code du cycle<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control text-uppercase" data-validate-length-range="3" data-validate-words="1" name="number_cycle" id="number_cycle" class='form-control' required="required" type="text" />
                                                <span class="fa fa-key form-control-feedback right" aria-hidden="true"></span>
                                            </div>
                                        </div>

                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Nom du cycle<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control text-uppercase" name="name_cycle" data-validate-length-range="3" data-validate-words="1" id="name_cycle" class='form-control' required="required" type="text" />
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <select class="form-control" name="name_session" id="name_session">
    ...
    <script src="<?= base_url()?>/function/cycle/save.js"></script>
