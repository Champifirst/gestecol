...
<body class="nav-md">
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Enregistrer les inscriptions</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="" id="from_pay_inscription" method="post" novalidate>
    ...
    <script src="<?= base_url()?>/function/inscription/save_inscription.js"></script>
