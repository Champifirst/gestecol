...
<head>
    ...
    <title>SM@RTSCHOOL | STUDENT </title>
...
<body class="nav-md">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <h4><span class="step_no p-3">STRUCTURE DU FICHIER ATTENDU</span> <font color="#1fb264">N° | NOM | PRENOM | DATE NAISSANCE | LIEU NAISSANCE | SEXE | NOM PARENT | PRENOM | EMAIL | PROFESSION | CONTACT | ADRESSE | INSCRIPTION</font> </h4>
                                    <hr>

                                    <form class="" id="from_import_student" method="post" novalidate>
                                        <h4><span class="step_no p-3">1</span> Informations personnelles, parents et tuteurs</h4>
                                        <hr>
    ...
    <script src="<?= base_url()?>/function/student/import.js"></script>
    <script>
