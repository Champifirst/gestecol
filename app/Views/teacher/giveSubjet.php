...
<body class="nav-md">
                                ...
                                <div class="x_content">
                                    ...
                                    <form method="POST" id="from_attribution_class">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <label for="cycle">classe</label>
                                                <div>
                                                    <select class="form-control" name="name_class" id="name_class" required="required">
                                            ...
                                            <table class="table table-bordered">
                                                <thead class="table-success">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="text-center" width="20%">MATIERES</th>
    ...
    <script src="<?= base_url()?>/function/teacher/giveSubjet.js"></script>
