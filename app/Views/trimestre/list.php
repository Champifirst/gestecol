...
<html lang="en">
  <head>
    ...
    <title>SM@RTSCHOOL | TRIMESTRE </title>
  ...
  <body class="nav-md">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Modifier le trimestre</h5>
    ...
    <script src="<?= base_url()?>/function/trimestre/list.js"></script>
