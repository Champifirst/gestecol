...
$(document).ready(function () {
    ...
    liste_trimestre(id_school);
});

function liste_trimestre(id_school) {
    let url = $('meta[name=app-url]').attr("content") + "/trimestre/all/"+id_school+"";
    ...
    $.ajax({
        ...
        success: function(json){
            ...
            for (var i = 0; i < json.length; i++) {
                let modifier = '';
                // let modifier = '<button class="btn btn-default btn-rounded btn-sm btn-select" onClick="select_data(' + json[i].trimestre_id + ','+i+')"><span class="fa fa-pencil"></span></button> ';
                let supprimer = '';
                if (type_user == "admin") {
                    supprimer = '<button class="btn btn-danger btn-rounded btn-sm btn-supprimer" onClick="delete_row(' + json[i].trimestre_id + ','+(i)+');"><span class="fa fa-times"></span></button>';
                }
                ...
                tableau[i][5] = (json[i].coded.toUpperCase());
                tableau[i][6] = (json[i].name.toUpperCase());
                tableau[i][7] = (modifier + '   ' + supprimer);
            }
...
function delete_row(id, ligne) {
    let url = $('meta[name=app-url]').attr("content") + "/trimestre/delete/"+id+"";
